...
struct Constants {
    ...
    static let pages = [
        ...
        Page(imageName: "ibeacon", headerText: "Attendance Tracking", description: "Automatically get marked in and out of the Make School HQ based on your location approximity."),
